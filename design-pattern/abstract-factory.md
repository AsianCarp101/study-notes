...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/1.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/2.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/3.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/4.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/5.png?raw=true)

那么，是否可以使用同一个工厂等级结构来对付这些相同或者极为相似的产品等级结构呢？当然可以的，而且这就是抽象工厂模式的好处。同一个工厂等级结构负责三个不同产品等级结构中的产品对象的创建。

![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/6.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/7.png?raw=true)

　　由于这两个产品族的等级结构相同，因此使用同一个工厂族也可以处理这两个产品族的创建问题，这就是抽象工厂模式。

　　根据产品角色的结构图，就不难给出工厂角色的结构设计图。

![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/8.png?raw=true)

　　可以看出，每一个工厂角色都有两个工厂方法，分别负责创建分属不同产品等级结构的产品对象。

![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/9.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/10.png?raw=true)

　　由于抽象工厂定义的一系列对象通常是相关或相互依赖的，这些产品对象就构成了一个产品族，也就是抽象工厂定义了一个产品族。

　　这就带来非常大的灵活性，切换产品族的时候，只要提供不同的抽象工厂实现就可以了，也就是说现在是以一个产品族作为一个整体被切换。

![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/11.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/12.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/13.png?raw=true)
...
![](https://github.com/liyayu/study-notes/blob/master/note-markdown-image/design-pattern/abstract-factory/14.png?raw=true)
